...
public class NonPreemptivePriorityClass {
    ...
    // Overloaded method to add a process with automatically assigned ID, priority, arrival time, and burst time
    ...
    public void execute() {
        ArrayList<PriorityProcess> inputOrderProcesses = new ArrayList<>(processes); // Copy to retain input order for printing
    ...
    // Method to display the results of the scheduling, including a process table and Gantt chart
    private void displayResults(ArrayList<PriorityProcess> inputOrderProcesses, int totalTurnaroundTime, int totalWaitingTime, int idleTime, int currentTime, StringBuilder ganttChartTop, StringBuilder ganttChartBottom, StringBuilder ganttChartTime) {
        ...
        // Calculate and print the average turnaround time, waiting time, and CPU utilization
